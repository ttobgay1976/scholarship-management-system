...
@Controller
@RequestMapping("/fund-request-submission")
public class BSAFundRequestSubmissionController {

    private static final Logger logger = LoggerFactory.getLogger(BSAFundRequestSubmissionController.class);

    private final BSAFundRequestService bsaFundRequestService;
    private final UserRepository userRepository;
    private final BSARegistrationRepository bsaRepository;

    public BSAFundRequestSubmissionController(BSAFundRequestService bsaFundRequestService,
